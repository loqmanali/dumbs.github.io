...
class CustomExpansionTile extends StatefulWidget {
  ...
  const CustomExpansionTile({
    ...
    this.leading,
    required this.title,
    this.secondaryTitle = const SizedBox.shrink(),
    this.flex = 1,
    this.icon,
    this.subtitle,
  ...
  /// when true, the title will be a row
...
class _CustomExpansionTileState extends State<CustomExpansionTile>
  ...
  void initState() {
    ...
    _icon = _controller.drive(_halfTween.chain(_easeInTween));
  ...
  Widget? _buildIcon(BuildContext context) {
    return RotationTransition(
      turns: _iconTurns,
      child: Icon(widget.icon ?? Icons.expand_more),
    );
  }
      ...
      child: Column(
        ...
        children: <Widget>[
          ListTileTheme.merge(
            ...
            child: Container(
              color: widget.headerBackgroundColor ?? Colors.black12,
              child: ListTile(
                onTap: _handleTap,
                contentPadding: widget.tilePadding,
                leading: widget.leading ?? _buildLeadingIcon(context),
                title: widget.isTitleRow
                    ? Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    ...
                    _isExpanded
                        ? Expanded(
                        flex: widget.flex,
                        child: Center(child: widget.secondaryTitle))
                        : const SizedBox(),
                  ],
                )
                    : widget.title,
